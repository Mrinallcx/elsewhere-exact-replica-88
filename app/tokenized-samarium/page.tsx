    ...
    <div className="min-h-screen w-full relative">
      ...
      <section id="products" className="px-4 sm:px-6 md:px-8 lg:px-12 py-20 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-gray-900 leading-tight mb-6">Two Ways to Own Samarium Digitally</h2>
          <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-4xl mb-12">Toto Finance is building two distinct tokenized samarium products: a 1:1 asset-backed token for refined samarium metal always redeemable for physical delivery, and In-Ground Samarium future delivery contracts for pre-production exposure.</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              ...
              <h3 className="text-2xl font-medium text-gray-900 mb-4">1:1 Samarium Metal Token</h3>
              <p className="text-gray-600 leading-relaxed mb-6">Every token is backed 1:1 by refined samarium metal stored in insured, audited vault facilities. High-purity samarium (99.9%+ Sm), ready for SmCo magnet manufacturing and aerospace applications. Always redeemable for physical samarium on demand.</p>
              <ul className="space-y-3">
                {['Backed 1:1 by refined samarium metal (99.9%+ purity grade)', 'Always redeemable for physical samarium delivery on demand', 'Stored in insured, independently audited vault and warehouse facilities', 'On-chain proof-of-reserves with real-time oracle feeds', 'Fractional ownership, 24/7 tradeable, instant stablecoin settlement', 'Ready for industrial end-use: aerospace, defense, oil & gas, high-temperature motors'].map((f, i) => (
            ...
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              ...
              <h3 className="text-2xl font-medium text-gray-900 mb-4">In-Ground Samarium</h3>
              <p className="text-gray-600 leading-relaxed mb-6">Tokenized future delivery contracts for physical samarium still in the ground at certified rare earth mining operations. Access samarium at pre-production economics, with delivery windows from months to years.</p>
              <ul className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-slate-50 rounded-2xl p-6 md:p-8 border border-slate-100">
              <span className="inline-block text-slate-700 text-xs font-semibold uppercase tracking-wider mb-3">Short-Term Delivery</span>
              <h3 className="text-xl font-medium text-gray-900 mb-2">1 &ndash; 12 Months</h3>
              <p className="text-sm text-gray-600 leading-relaxed">Near-term samarium delivery contracts tied to active rare earth mining operations approaching production. Ideal for defense procurement, near-term portfolio allocation, and buyers seeking defined delivery timelines with transparent reserve verification.</p>
            </div>
            <div className="bg-gray-100 rounded-2xl p-6 md:p-8 border border-gray-200">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">Strategic samarium positions backed by proven reserves at earlier-stage rare earth mining operations. Built for sovereign wealth funds, defense agencies, and forward-looking investors positioning for the multi-year samarium supply deficit.</p>
            </div>
          </div>
        </div>
      </section>
