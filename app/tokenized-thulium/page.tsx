    ...
    <div className="min-h-screen w-full relative">
      ...
      <section id="products" className="px-4 sm:px-6 md:px-8 lg:px-12 py-20 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-gray-900 leading-tight mb-6">Two Ways to Own Thulium Digitally</h2>
          <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-4xl mb-12">Toto Finance is building two distinct tokenized thulium products: a 1:1 asset-backed token for refined thulium oxide always redeemable for physical delivery, and In-Ground Thulium future delivery contracts for pre-production exposure.</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              ...
              <h3 className="text-2xl font-medium text-gray-900 mb-4">1:1 Thulium Oxide Token</h3>
              <p className="text-gray-600 leading-relaxed mb-6">Every token is backed 1:1 by refined thulium oxide (Tm&#x2082;O&#x2083;) stored in insured, audited vault facilities. High-purity thulium oxide (99.9%+ Tm&#x2082;O&#x2083;), ready for medical laser fiber production and radioisotope applications. Always redeemable for physical thulium on demand.</p>
              <ul className="space-y-3">
                {['Backed 1:1 by refined thulium oxide (99.9%+ purity grade)', 'Always redeemable for physical thulium delivery on demand', 'Stored in insured, independently audited vault and warehouse facilities', 'On-chain proof-of-reserves with real-time oracle feeds', 'Fractional ownership, 24/7 tradeable, instant stablecoin settlement', 'Ready for industrial end-use: medical fiber lasers, portable X-ray sources, industrial radiation, superconductors'].map((f, i) => (
            ...
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              ...
              <h3 className="text-2xl font-medium text-gray-900 mb-4">In-Ground Thulium</h3>
              <p className="text-gray-600 leading-relaxed mb-6">Tokenized future delivery contracts for physical thulium still in the ground at certified rare earth mining operations. Access thulium at pre-production economics, with delivery windows from months to years.</p>
              <ul className="space-y-3">
                {['Backed by proven thulium content in heavy rare earth reserves at partner mining sites', 'Pre-production pricing with built-in supply scarcity premium', 'On-chain reserve tracking with geological data transparency', 'Physical delivery or settlement at maturity', 'Verified reserves with third-party geological audits', 'Designed for institutional, sovereign, and long-duration strategies'].map((f, i) => (
                  <li key={i} className="flex items-start gap-3 text-sm text-gray-600">
                    <svg className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                    {f}
                  </li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-pink-50 rounded-2xl p-6 md:p-8 border border-pink-100">
              <span className="inline-block text-pink-700 text-xs font-semibold uppercase tracking-wider mb-3">Short-Term Delivery</span>
              <h3 className="text-xl font-medium text-gray-900 mb-2">1 &ndash; 12 Months</h3>
              <p className="text-sm text-gray-600 leading-relaxed">Near-term thulium delivery contracts tied to active rare earth mining operations with heavy rare earth separation approaching production. Ideal for medical device manufacturers, radioisotope producers, near-term portfolio allocation, and buyers seeking defined delivery timelines with transparent reserve verification.</p>
            </div>
            <div className="bg-rose-50 rounded-2xl p-6 md:p-8 border border-rose-100">
              <span className="inline-block text-rose-700 text-xs font-semibold uppercase tracking-wider mb-3">Long-Term Delivery</span>
              <h3 className="text-xl font-medium text-gray-900 mb-2">1 &ndash; 6 Years</h3>
              <p className="text-sm text-gray-600 leading-relaxed">Strategic thulium positions backed by proven thulium content in heavy rare earth reserves at earlier-stage mining operations. Built for sovereign wealth funds, medical laser manufacturers, portable imaging developers, and forward-looking investors positioning for the multi-year thulium supply deficit.</p>
            </div>
          </div>
        </div>
      </section>
