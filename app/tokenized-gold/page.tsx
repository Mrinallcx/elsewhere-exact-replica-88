        ...
        <div className="flex justify-between items-center px-4 sm:px-6 md:px-12 lg:px-20 py-2 md:py-1">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-8">
                <a href="/war-ready-package" className="nav-link text-travel-black hover:text-travel-black transition-colors duration-300 flex items-center space-x-2">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mission-grid">
            <div className="mission-content">
             ...
             <div className="mission-image group">
               <img 
            ...
            <div className="blog-marquee-track">
              ...
              <article className="blog-card blog-card--marquee">
                <div className="blog-card-image-wrapper">
                  <img src="https://firebasestorage.googleapis.com/v0/b/tiamonds.firebasestorage.app/o/3%20(1).png?alt=media&token=50212f13-6a4a-41fd-96f7-f6051ca83cdf" alt="Gold Market Analysis" className="blog-card-image" />
                </div>
              ...
              <article className="blog-card blog-card--marquee">
                <div className="blog-card-image-wrapper">
                  <img src="https://firebasestorage.googleapis.com/v0/b/tiamonds.firebasestorage.app/o/gold.png?alt=media&token=2df54300-9089-416b-8f50-4cd359b415c0" alt="Complete Guide to Gold Tokenization" className="blog-card-image" />
                </div>
                <div className="blog-card-body">
              ...
              <article className="blog-card blog-card--marquee">
                <div className="blog-card-image-wrapper">
                  <img src="https://firebasestorage.googleapis.com/v0/b/tiamonds.firebasestorage.app/o/Silver.png?alt=media&token=05a8833b-11de-49cf-9bd9-bb9a66262237" alt="Security & Transparency in Digital Gold" className="blog-card-image" />
                </div>
                <div className="blog-card-body">
        ...
        <div className="newsletter-bg">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center px-6 md:px-8 lg:px-12">
            ...
            <p className="newsletter-subtitle">
              Subscribe for the latest gold market insights,<br />
