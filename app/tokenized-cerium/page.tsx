    ...
    <div className="min-h-screen w-full relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 backdrop-blur-sm">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">Cerium Oxide (CeO&#8322;) / 99.5% Oxide Price</p>
                  <p className="text-sm text-gray-400">Global Rare Earth Market</p>
                </div>
                <div className="text-right">
                  <p className="text-3xl md:text-4xl font-light text-white">$2,150</p>
              ...
              <div className="border-t border-white/10 pt-5 grid grid-cols-2 gap-4">
                <div className="bg-white/5 rounded-xl p-4">
                  ...
                  <p className="text-lg font-semibold text-white">$2.4B+</p>
                  <p className="text-xs text-gray-500">2025</p>
                </div>
                <div className="bg-white/5 rounded-xl p-4">
                  <p className="text-xs text-gray-400 mb-1">2025 Deficit</p>
                  <p className="text-lg font-semibold text-white">18,500 t</p>
                  <p className="text-xs text-gray-500">Roskill</p>
                </div>
                <div className="bg-white/5 rounded-xl p-4">
                  <p className="text-xs text-gray-400 mb-1">2026 Forecast</p>
                  <p className="text-lg font-semibold text-white">$2,500/mt</p>
                  <p className="text-xs text-gray-500">Roskill</p>
                </div>
                <div className="bg-white/5 rounded-xl p-4">
      ...
      <section id="products" className="px-4 sm:px-6 md:px-8 lg:px-12 py-20 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-gray-900 leading-tight mb-6">
            Two Ways to Own Cerium Digitally
          </h2>
          <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-4xl mb-12">
            Toto Finance is building two distinct tokenized cerium products: a 1:1 asset-backed token for refined cerium oxide always redeemable for physical delivery, and In-Ground Cerium future delivery contracts for pre-production exposure.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              ...
              <h3 className="text-2xl font-medium text-gray-900 mb-4">1:1 Cerium Oxide Token</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                Every token is backed 1:1 by refined cerium oxide (CeO&#8322;) stored in insured, audited vault facilities. High-purity cerium oxide (99.5%+ CeO&#8322;), ready for automotive catalyst production, glass polishing applications, and industrial use. Always redeemable for physical cerium on demand.
              </p>
              <ul className="space-y-3">
                {[
                  'Backed 1:1 by refined cerium oxide (99.5%+ purity grade)',
                  'Always redeemable for physical cerium delivery on demand',
                  ...
                  'Ready for industrial end-use: catalytic converters, glass polishing, diesel additives, ceramic coatings',
                ].map((feature, i) => (
            ...
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              ...
              <h3 className="text-2xl font-medium text-gray-900 mb-4">In-Ground Cerium</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                Tokenized future delivery contracts for physical cerium still in the ground at certified rare earth mining operations. Access cerium at pre-production economics, with delivery windows from months to years.
              </p>
              <ul className="space-y-3">
                {[
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-orange-50 rounded-2xl p-6 md:p-8 border border-orange-100">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Near-term cerium delivery contracts tied to active rare earth mining operations approaching production. Ideal for automotive manufacturers, glass manufacturers, near-term portfolio allocation, and buyers seeking defined delivery timelines with transparent reserve verification.
              </p>
            </div>
            <div className="bg-amber-50 rounded-2xl p-6 md:p-8 border border-amber-100">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Strategic cerium positions backed by proven reserves at earlier-stage rare earth mining operations. Built for sovereign wealth funds, automotive OEMs, glass and optics manufacturers, and forward-looking investors positioning for the multi-year cerium supply deficit.
              </p>
            </div>
          </div>
        </div>
