    ...
    <div className="min-h-screen w-full relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 backdrop-blur-sm">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">Erbium Oxide (Er&#8322;O&#8323;) / 99.9% Oxide Price</p>
                  <p className="text-sm text-gray-400">Global Rare Earth Market</p>
                </div>
                <div className="text-right">
                  <p className="text-3xl md:text-4xl font-light text-white">$128,000</p>
                  <p className="text-sm text-green-400 font-medium">&uarr; +58% YTD</p>
                </div>
              </div>
              <div className="border-t border-white/10 pt-5 grid grid-cols-2 gap-4">
                <div className="bg-white/5 rounded-xl p-4">
                  ...
                  <p className="text-lg font-semibold text-white">$320M+</p>
                  <p className="text-xs text-gray-500">2025</p>
                </div>
                <div className="bg-white/5 rounded-xl p-4">
                  <p className="text-xs text-gray-400 mb-1">2025 Deficit</p>
                  <p className="text-lg font-semibold text-white">95 t</p>
                  <p className="text-xs text-gray-500">Roskill</p>
                </div>
                <div className="bg-white/5 rounded-xl p-4">
                  <p className="text-xs text-gray-400 mb-1">2026 Forecast</p>
                  <p className="text-lg font-semibold text-white">$145,000/mt</p>
                  <p className="text-xs text-gray-500">Roskill</p>
                </div>
                <div className="bg-white/5 rounded-xl p-4">
      ...
      <section id="products" className="px-4 sm:px-6 md:px-8 lg:px-12 py-20 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-gray-900 leading-tight mb-6">
            Two Ways to Own Erbium Digitally
          </h2>
          <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-4xl mb-12">
            Toto Finance is building two distinct tokenized erbium products: a 1:1 asset-backed token for refined erbium oxide always redeemable for physical delivery, and In-Ground Erbium future delivery contracts for pre-production exposure.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              ...
              <h3 className="text-2xl font-medium text-gray-900 mb-4">1:1 Erbium Oxide Token</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                Every token is backed 1:1 by refined erbium oxide (Er&#8322;O&#8323;) stored in insured, audited vault facilities. High-purity erbium oxide (99.9%+ Er&#8322;O&#8323;), ready for fiber optic amplifier production and medical laser applications. Always redeemable for physical erbium on demand.
              </p>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              ...
              <h3 className="text-2xl font-medium text-gray-900 mb-4">In-Ground Erbium</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                Tokenized future delivery contracts for physical erbium still in the ground at certified rare earth mining operations. Access erbium at pre-production economics, with delivery windows from months to years.
              </p>
              <ul className="space-y-3">
                {[
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-rose-50 rounded-2xl p-6 md:p-8 border border-rose-100">
              <span className="inline-block text-rose-700 text-xs font-semibold uppercase tracking-wider mb-3">Short-Term Delivery</span>
              <h3 className="text-xl font-medium text-gray-900 mb-2">1 &ndash; 12 Months</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
                Near-term erbium delivery contracts tied to active rare earth mining operations with heavy rare earth separation approaching production. Ideal for telecommunications companies, data center operators, near-term portfolio allocation, and buyers seeking defined delivery timelines with transparent reserve verification.
              </p>
            </div>
            <div className="bg-amber-50 rounded-2xl p-6 md:p-8 border border-amber-100">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Strategic erbium positions backed by proven erbium content in heavy rare earth reserves at earlier-stage mining operations. Built for sovereign wealth funds, telecommunications infrastructure developers, data center operators, and forward-looking investors positioning for the multi-year erbium supply deficit.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 sm:px-6 md:px-8 lg:px-12 py-20 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-4xl mb-12">
            Toto Finance serves three distinct categories of buyers, each with different motivations for accessing tokenized erbium and In-Ground Erbium contracts.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              <span className="inline-block bg-rose-100 text-rose-800 text-xs font-semibold uppercase tracking-wider px-3 py-1 rounded-full mb-4">Category 1</span>
              <h3 className="text-xl font-medium text-gray-900 mb-3">Industrial Clients</h3>
              <p className="text-sm text-gray-600 leading-relaxed mb-4">
                Companies that need physical erbium directly for manufacturing and operations. They purchase tokenized erbium for guaranteed supply, streamlined procurement, and physical redemption.
              </p>
              <p className="text-xs text-gray-500 leading-relaxed">
                Telecommunications infrastructure and fiber optic network operators, data center operators and cloud service providers, fiber optic amplifier manufacturers, undersea cable system developers, 5G network equipment manufacturers, medical laser manufacturers (dermatology and dental), optical fiber manufacturers, laser crystal and component manufacturers, glass and optical coating producers, nuclear reactor manufacturers.
              </p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
              ...
              <p className="text-sm text-gray-600 leading-relaxed mb-4">
                Mid-size and smaller investment firms, commodity brokers, family offices, and individual investors who typically cannot access premium erbium deals at the pricing and scale that major institutions command.
              </p>
              <p className="text-xs text-gray-500 leading-relaxed">
                Toto Finance democratizes access to institutional-grade erbium positions. Fractional ownership, no minimum kilogram requirements, no warehouse logistics, and no counterparty risk through intermediaries. The same erbium, at competitive pricing, accessible to everyone.
              </p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-gray-900 text-white rounded-2xl p-6 md:p-8">
              ...
              <p className="text-sm text-gray-400 mt-4 leading-relaxed">
                Similar to how Amazon and eBay match buyers and sellers directly for physical goods, Toto Finance uses blockchain technology to connect erbium producers with buyers, eliminating banks, clearing houses, and settlement agents entirely.
              </p>
            </div>
          </div>
      ...
      <section className="px-4 sm:px-6 md:px-8 lg:px-12 py-20 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-4xl mb-12">
            Once tokenized erbium is purchased on Toto Finance, secondary trading happens on DeFi platforms globally. Hold, trade, hedge, earn yield, or borrow against your erbium. All on-chain. All programmable.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {[
              { title: 'Global Secondary Trading', desc: 'Tokenized erbium trades 24/7 on decentralized exchanges and DeFi platforms worldwide. Buy, sell, and transfer erbium tokens across chains without gatekeepers, brokers, or trading hour restrictions. True global liquidity.' },
              { title: 'On-Chain Yield', desc: 'Earn yield by exposing erbium assets to smart contract yield contracts. Lend tokenized erbium to short sellers or leveraged long traders who borrow assets and pay interest. Passive income backed by physical rare earth metals.' },
              { title: 'Collateral Loans', desc: 'Use tokenized erbium as collateral for on-chain loans. Borrow stablecoins against erbium holdings without selling the underlying asset. All managed at the protocol level — no bank approval, no credit checks, no delays.' },
              { title: 'Programmable Finance', desc: 'Collateral loans backed by tokenized erbium represent a new programmable financial model. Smart contracts automate liquidation thresholds, interest payments, and margin requirements. Physical rare earth value meets decentralized infrastructure.' },
            ].map((feature, i) => (
          ...
          {/* Token Lifecycle */}
          <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
            <h3 className="text-xl font-medium text-gray-900 mb-6 text-center">The Lifecycle of a Tokenized Erbium Token</h3>
            <div className="flex flex-col md:flex-row items-center justify-between gap-2 md:gap-0">
              {[
                ...
                'Redeemed for Physical Erbium Oxide',
              ].map((step, i) => (
      ...
      <section className="px-4 sm:px-6 md:px-8 lg:px-12 py-20 md:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-gray-900 leading-tight mb-6">
            Tokenized Erbium vs. Traditional Rare Earth Investment
          </h2>
          <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-4xl mb-12">
            See how tokenized erbium on Toto Finance compares to traditional rare earth ETFs, futures contracts, and physical ownership.
          </p>
            ...
            <table className="w-full text-sm text-left">
              ...
              <tbody className="bg-white">
                {[
                  ...
                  ['Physical Backing', 'Synthetic / Basket', '1:1 Erbium Oxide', 'Direct ownership', 'No (equity)'],
      ...
      <section className="px-4 sm:px-6 md:px-8 lg:px-12 py-20 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-gray-900 leading-tight mb-6">
            Institutional-Grade Erbium Tokenization
          </h2>
          <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-4xl mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Redeemable Assets', desc: 'All tokenized erbium is linked to insured vaults and custody facilities. Redeem tokens for physical erbium oxide delivery on demand. High-purity grade (99.9%+ Er₂O₃), ready for industrial use.' },
              ...
              { title: 'DeFi Yield & Loans', desc: 'Earn yield through lending protocols, use erbium as collateral for on-chain loans, or hedge positions through smart contracts. Programmable finance for physical assets.' },
              { title: 'Multi-Chain Access', desc: 'Tokenized erbium is accessible across Ethereum, Polygon, Cardano, Solana, and XRP Ledger. Trade on the chain that works best for your strategy.' },
            ].map((feature, i) => (
